...
#define TIMEOUT_MS                 20000  /* ms para ingresar PIN */
#define OMITIR_SENSOR_CIERRE       1      /* 1=omitir sensor cierre (pruebas) */
#define OMITIR_MOTOR               1      /* 1=omitir control motor (pruebas) */
