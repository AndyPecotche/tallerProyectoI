    ...
    switch(g_scan.st){
        ...
        case ST_WAIT_GETIMAGE: {
            ...
            if (code != 0xFF){
                ...
                // Si no se recibió ACK válido, pero ya pasó un tiempo, asumir sin dedo para no quedar bloqueado
...
// Funci�n p�blica para borrar una ID espec�fica
...
// Busca la huella que est� en el Buffer 1 dentro de toda la memoria.
